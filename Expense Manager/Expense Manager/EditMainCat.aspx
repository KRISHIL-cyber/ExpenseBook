<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.Master" AutoEventWireup="true" CodeBehind="EditMainCat.aspx.cs" Inherits="Expense_Manager.EditMainCat" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Edit Main Catagory</title>   
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-info">
        <div class =" panel-heading"><h5>Edit Main Category</h5></div>
    ...
    <!------------------------GridView datatable jquery link----------------------
